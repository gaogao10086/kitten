...
public interface RoleMapper {
    ...
    List<RoleEntity> getRolesByAdminId(
    ...
    int roleAdd(RoleEntity roleEntity) throws Exception;

    @Insert("INSERT INTO AdminRoleMember (adminId,roleId) VALUES (#{adminId},#{roleId})")
    int adminRoleMemberAdd(AdminRoleMember adminRoleMember) throws Exception;

    @Insert("INSERT INTO RoleMenuMember (menuID,roleID) VALUES (#{menuID},#{roleID})")
    int roleMenuMemberAdd(RoleMenuMember roleMenuMember) throws Exception;
    ...
    int roleUpdate(RoleEntity roleEntity) throws Exception;

    @Update("UPDATE AdminRole SET  status = #{status},updateTime=CURRENT_TIMESTAMP,updatedBy=#{updatedBy} WHERE roleId=#{roleId}")
    int roleEnable(RoleEntity roleEntity) throws Exception;

    @Delete("DELETE FROM  AdminRole  WHERE roleId=#{roleId}")
    int roleDelete(RoleEntity roleEntity) throws Exception;

    @DeleteProvider(type = RoleProvider.class, method = "adminRoleMemberDelete")
    int adminRoleMemberDelete(@Param("adminRoleMember") AdminRoleMember adminRoleMember) throws Exception;

    @DeleteProvider(type = RoleProvider.class, method = "roleMenuMemberDelete")
    int roleMenuMemberDelete(@Param("roleMenuMember") RoleMenuMember roleMenuMember) throws Exception;
